...
from isaaclab.sensors import patterns, RayCasterCfg
from isaaclab_tasks.manager_based.locomotion.velocity.velocity_env_cfg import LocomotionVelocityRoughEnvCfg

##
# Pre-defined configs
##
from isaaclab_tasks.manager_based.locomotion.velocity.config.cerberus.cerberus import CERBERUS_CFG  # isort: skip


@configclass
class CerberusRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
...
@configclass
class CerberusRoughEnvCfg_PLAY(CerberusRoughEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
